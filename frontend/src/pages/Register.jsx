...
import { register, guestLogin } from '../utils/api';
import './Auth.css';
    ...
    <div className="auth-page">
      <div className="auth-card glass fade-in">
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <button id="reg-submit" type="submit" className="btn btn-primary" style={{ width: '100%', justifyContent: 'center', padding: '13px', marginBottom: '10px' }} disabled={loading}>
